...
if __name__ == '__main__':
    # 1. Генерируем супер сложный контур
    # max_freq=40 — очень много изгибов
    # n_points=1500 — высокая детализация
    cx, cy = generate_random_complex_contour(n_points=1500, max_freq=40, seed=777)

    # Чтобы пики были ВЫШЕ, можно вручную домножить отклонения от центра (опционально)
    cx *= 1.2
    cy *= 1.2

    # 2. Запускаем разложение
